...
python -u apply_model_vit_pandas.py \
            ...
            --label_type 'THETA' \
            --cpu_or_gpu 'gpu' \
            --input_model_path '/fs/ess/PAS2159/neutrino/torch_models/simple_theta_regression_save.pt' \
            --output_ana_path '/fs/ess/PAS2159/neutrino/ana/pd_results_dtheta.csv' \
            >& logs/apply_vit_neutrino_THETA_pandas_gpu.log
